...
const createAktBoSpecTemplate = (paspec) => {
    return `
      <div class="aktBo-spec-content akt-spec-content">
        ...
        <div class="table-responsive pa-spec-container akt-spec-container">
          <table class="table caption-top pa-spec-table table-bordered">
            <caption class="aktBo-title akt-title">Спецификация атка безналичного отпуска</caption>
...
export default class aktBoSpecView {
  constructor(paspec) {
    this.paspec = paspec;
  }

  getTemplate() {
    return createAktBoSpecTemplate(this.paspec);
  }
